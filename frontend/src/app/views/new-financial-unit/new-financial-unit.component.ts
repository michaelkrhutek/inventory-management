...
@Component({
  selector: 'app-new-financial-unit',
  templateUrl: './new-financial-unit.component.html',
  styleUrls: ['./new-financial-unit.component.css'],
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class NewFinancialUnitComponent {
